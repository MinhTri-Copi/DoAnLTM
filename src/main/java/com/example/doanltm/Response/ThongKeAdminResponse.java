...
public class ThongKeAdminResponse implements Serializable {
    ...
    public ThongKeAdminResponse() {}
    
    public ThongKeAdminResponse(boolean success, String message) {
        this.success = success;
        this.message = message;
    }
    
    public ThongKeAdminResponse(boolean success, String message, int monthlyTotal, 
    ...
    public String toString() {
        return "ThongKeAdminResponse{success=" + success + ", message='" + message + 
